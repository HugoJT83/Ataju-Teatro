        ...
        <>
            <footer className="text-gray-600 fixed bottom-0 w-full">
                <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                    <Link to={"/"} className="flex items-center md:justify-start justify-center text-gray-900 hover:cursor-pointer">
                        <img src={logo} alt="" className='w-20 h-20' />
                    </Link>
                    <p className="text-lg text-gray-500 font-title sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
